  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="#" alt="Admission Section" width="300px" height="80px"></center>
...
<div class="form-group col-md-6">
<label for="aadharno">ID Card No.</label>
<input type="text" class="form-control" name="user_aadhar" maxlength="12" placeholder="Enter student ID card no. ">
</div>
</div>
			...
			<div class='container' id='profile'>
				<div class='row'>
					...
					<div class='col-sm-3 col-md-6'>
						...
						<strong>Mother Name :</strong>$mother <br>
						<strong>DOB :</strong>$Bday <br>
						<strong>Student ID :</strong> $aadhar <br>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<input type='text' class='form-control' name='user_aadhar' maxlength='12' placeholder='Enter student ID card no. ' value='$aadhar'>
		</div>
		</div>
